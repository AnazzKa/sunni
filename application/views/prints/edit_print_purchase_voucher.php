...
<div id="print">
    ...
    <a id="back_button" href="<?php echo base_url();?>admin/purchase/get_payable_amount" style="text-decoration: none; background-color: #3c8dbc; color: #FFF; height: 34px; padding: 10px">Back</a>
    <div class="book">
            ...
            <div class="sub_page">
                ...
                <div class="head">
                    ...
                    <div class="customer_det">
                        ...
                        <h3 class="mnads"><?php echo $payment['v_name'];?><br>
                            <span class="cusu_ads"><?php echo $payment['v_address'];?><br>

                                <?php echo $payment['v_mobile'];?>
                        </span>
                        </h3>
                    ...
                    <h2 class="invstxthd"><b><u>Payment Voucher</u></b></h2>

                    <table>
                        <tr>
                            <td class="brdrno">Date: <span><?php echo $payment['paid_date'];?></span></td>
                            <td class="brdrno" style="text-align: right;">Voucher Number: <span><?php echo $payment['voucher_no'];?></span></td>
                        </tr>
                    </table>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>1</td>
                            <td>Purchase Number: <?php echo $payment['purchase_no'];?> </td>
                    ...
                    <?php $amont_inwords = amountInwords($payment['amount']);
