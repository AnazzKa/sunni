...
<html>
<head>
    <title>Mckinley - Forgot Password</title>
</head>
<body>
    ...
    <tr>
        <td align="center" valign="top" style="padding: 0 10px;">
            <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="border-collapse: collapse; font-family:'Roboto',sans-serif;font-size: 32px;font-weight: bold;color: #3392ea; max-width: 600px;">
                <tbody>
                <tr>
                    <td align="left" style="padding: 18px 0 7px 5px;"><a href="" style="color: #689c35;text-decoration: none;" target="_blank" rel="noopener"> <span style="color: #555555;text-decoration: none; font-size=12px"><img src="<?php echo base_url();?>assets/admin/images/anona-logo.png" width="120" alt="Meckinley"> </span> </a></td>
                </tr>
                </tbody>
            </table>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" align="center" style="border-collapse: collapse;">
                            ...
                            <tr>
                                <td align="left" style="padding: 25px;">
                                    <h3 style="margin: 0; text-align: center; padding: 0 0 10px; font-weight: normal; font-weight: normal; font-size: 26px; color: #09ad8b; line-height: 32px; font-family:'Roboto',sans-serif; "> <strong>Hi Admin</strong>, Please change your password by visiting the link given below.</h3>
                                    ...
                                    <div style="border-bottom: 1px dashed #ccc; padding: 10px 0; line-height: 160%; font-size: 15px;">
                                        <div style="color: #555555; line-height: 160%;font-family:'Roboto',sans-serif;">
                                            <br>
                                            <a href="<?php echo base_url();?>admin/login/change_your_password/<?= encrypt($userna); ?>/<?= encrypt($random) ?>" class="btn btn-danger">Visit Link </a>
                                        </div>
                                    </div>
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-collapse: collapse;">
                                        <tbody><tr>
                                            <td align="center" style="padding: 25px 0;"><p style="color: #555555; font-size: 16px; line-height: 140%; margin: 0; padding: 0;">
                                                    <span style="font-size: 14px;font-family:'Roboto',sans-serif;">If you got any questions for us, drop us a not at <a href="" style="text-decoration: none; color: #3392ea;" target="_blank" rel="noopener">support@meckinley.in </a> or call us on +91-900000000 . </span> </p></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </td>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; max-width: 600px;" align="center">
                <tbody>
                <tr>
                    <td align="center" style="padding: 0px; text-align: center;"><p style="padding: 20px 40px 15px; margin: 0; color: #000; line-height: 22px; font-size: 14px; margin: 0; font-family: 'Open Sans',Arial, Helvetica, sans-serif;"> At <meckinley></meckinley>, we passionately believe in keeping our customer's interest on top of everything else. <a href="<?php echo base_url();?>home" style="text-decoration: none; color: #3392ea;" target="_blank" rel="noopener">Visit Mckiney</a>. </p></td>
                </tr>
                </tbody>
            </table>
        </td>
