                            ...
                            <table id="example" class="display table-bordered table-striped" cellspacing="0" width="100%">
                                ...
                                <?php $i=1; foreach ($educations as $education){ ?>
                                    <tr>
                                        <td><?php echo $i;?></td>
                                        <td class="txt_educ">
                                            <input type="hidden" class="educ_id" value="<?php echo $education['id'];?>">
                                            <?php echo $education['title'];?></td>


                                        <td>
                                            <input type="checkbox" name="" value="<?php echo $education['id'];?>" class="chck_educ">
